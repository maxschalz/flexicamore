#ifndef FLEXICAMORE_SRC_SHARED_SWU_ENRICHMENT_H_
#define FLEXICAMORE_SRC_SHARED_SWU_ENRICHMENT_H_
 ...
 public:
  ...
  virtual double convert(
      ...
      cyclus::ExchangeTranslationContext<cyclus::Material> const* ctx =
          NULL) const {
    cyclus::toolkit::Assays assays(
        feed_assay, cyclus::toolkit::UraniumAssayMass(m), tails_assay);
...
/// @class SharedSwuEnrichment
///
/// The SharedSwuEnrichment facility is entirely based on Cycamore's Enrichment
...
/// the simulation.
class SharedSwuEnrichment : public cyclus::Facility,
                            public cyclus::toolkit::Position {
 public:
  explicit SharedSwuEnrichment(cyclus::Context* ctx);

  ~SharedSwuEnrichment();

  friend class SharedSwuEnrichmentTest;
...
#pragma cyclus note { \
    ...
    "doc": "The SharedSwuEnrichment facility is entirely based on Cycamore's " \
...
#endif  // FLEXICAMORE_SRC_SHARED_SWU_ENRICHMENT_H_
