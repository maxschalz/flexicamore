...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void PakistanEnrichmentTest::SetUp() {
  cyclus::PyStart();
  cyclus::Env::SetNucDataPath();

  fake_sim = new cyclus::MockSim(1);
  flex_enrich_facility = new PakistanEnrichment(fake_sim->context());

  InitParameters();
  SetUpPakistanEnrichment();
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void PakistanEnrichmentTest::TearDown() {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void PakistanEnrichmentTest::InitParameters() {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void PakistanEnrichmentTest::SetUpPakistanEnrichment() {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, Print) {
  EXPECT_NO_THROW(std::string s = flex_enrich_facility->str());
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, Tick) {
  EXPECT_NO_THROW(flex_enrich_facility->Tick());
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, Tock) {
  EXPECT_NO_THROW(flex_enrich_facility->Tock());
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, DISABLED_GetMatlRequests) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, CheckFeedQty) {
  for (int i = 0; i < feed_commods.size(); ++i) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, CheckFeedPrefs) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, AddFeedMaterial) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, Enrich) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, GetMatlBids) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, DISABLED_BidPrefs) {
  ...
  int simdur = 1;
  cyclus::MockSim sim(cyclus::AgentSpec(":flexicamore:PakistanEnrichment"),
                      config, simdur);
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, DISABLED_NoBidPrefs) {
  // Test disabled, see https://git.rwth-aachen.de/nvd/fuel-cycle/flexicamore/-/issues/4
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, CheckSWUConstraint) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, CheckMultipleSWUConstraints) {
  // Ensure that requests exceeding the SWU constraint are fulfilled only up to
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, FeedConstraint) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, RequestSim) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, TailsTrade) {
  std::string config =
    "   <feed_commods>"
    "     <val>"+feed_commods[0]+"</val> "
    "     <val>"+feed_commods[1]+"</val> "
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TEST_F(PakistanEnrichmentTest, ValidRequest) {
